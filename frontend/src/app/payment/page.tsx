        ...
        <section className="space-y-6">
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
             {/* Monthly (disabled) */}
  <div
    className="text-left rounded-xl opacity-60 pointer-events-none"
    aria-disabled="true"
  >
    <Card className="m-0">
      <CardContent className="px-6">
        <div className="flex h-[150px] flex-col items-center justify-center gap-1 text-center">
          ...
          {/* Coming Soon label */}
          <div className="relative w-[139px] h-[24px]">
            <span className="absolute left-0 top-0 font-montserrat font-semibold text-[20px] leading-[24px] text-[#DADADD]">
              Coming Soon
            </span>
          </div>
        </div>
