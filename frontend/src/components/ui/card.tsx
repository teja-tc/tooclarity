...
function _Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
...
function _CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function _CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
